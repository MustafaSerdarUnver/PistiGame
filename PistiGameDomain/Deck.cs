    ...
    public class Deck
    {
        ...
        private void GenerateCards()
        {
            for (int CardType = 0; CardType < 4; CardType++)
            {
                ...
                {
                    Card newCard = new Card((CardTypes)CardType, CardNumber, @"F:\Usb\WindowsFormUygulamaları\PistiGameExample\PistiGameDomain\Resources\" + (CardType * 13 + CardNumber) + ".png");
                    CardDeck.Add(newCard);
                }
            }
            closedCardPath = @"F:\Usb\WindowsFormUygulamaları\PistiGameExample\PistiGameDomain\Resources\closedCard.png";
        }
